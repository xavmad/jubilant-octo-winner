...
function activateGroup(project) {
  ...
  setTimeout(() => {
    ...
    }, 400); // Delay image formation by 1000ms (1 second)
    ...
    setTimeout(() => {
      // Reveal the project description after the zoom-in transition
      ...
      // Unlock the camera after the transition is complete
      cameraLocked = false;
