...
ffunction activateGroup(project) {
  ...
  setTimeout(() => {
    ...
    const CENTER_X = -window.innerWidth * 0.32; // Adjust this value to center the group better
    const CENTER_Y = 0;
    ...
    // Adjust the target origin values to focus the camera on the screen's center, 
    // while keeping the group positioned to the left of the screen.
    targetScale = 1;
