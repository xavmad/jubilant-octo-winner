...
function activateGroup(project) {
  ...
  setTimeout(() => {
    ...
    /* CAMERA FRAMES GROUP — TARGETS ONLY */
    targetScale = 1;
	
    const currentCenterX = originX;
	const currentCenterY = originY;

	targetOriginX = currentCenterX - CENTER_X;
	targetOriginY = currentCenterY - CENTER_Y;
