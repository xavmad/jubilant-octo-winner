...
function activateGroup(project) {
  ...
  setTimeout(() => {
    ...
    const CENTER_X = -window.innerWidth * 0.4; // This positions the group at the center-left
    const CENTER_Y = 0;
    ...
    groupImages.forEach((img, i) => {
      ...
      const x = CENTER_X + Math.cos(angle) * radius;  // Keep images aligned to center-left
    ...
    /* ==========================================
       CAMERA FRAMES GROUP — KEEP CAMERA CENTERED
    ========================================== */

    const screenAnchorX = window.innerWidth * 0.5; // Camera stays centered
    ...
    // Show the project description with a slight delay after the zoom transition
    setTimeout(() => {
