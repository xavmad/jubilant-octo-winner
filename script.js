...
function activateGroup(project) {
  ...
  setTimeout(() => {
    ...
    // **Delayed Image Formation + Description**
    setTimeout(() => {
      // Show the description at the same time as images start forming
    ...
    }, 400);  // Delay image formation for 1 second (same as the description appearing)
