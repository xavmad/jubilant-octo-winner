...
function activateGroup(project) {
  ...
  // Immediately show the description after the group is activated (no delay)
  ...
  setTimeout(() => {
    ...
    // **Delay the description until after zoom-in transition**
    setTimeout(() => {
      // Reveal the project description after the zoom and image formation is done
      descriptions.classList.add("visible");
