...
function groupCameraLoop() {
  ...
  if (progress < zoomDuration) {
    ...
    // Linear interpolation for direct zoom without easing
    const t = progress / zoomDuration;

    // Apply the linear transition directly (no easing, straight line)
    ...
    requestAnimationFrame(groupCameraLoop); // Continue looping
  } else {
