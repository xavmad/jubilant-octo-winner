...
function activateGroup(project) {
  ...
  setTimeout(() => {
    ...
    // Adjust targetOriginX and targetOriginY to focus on the center, while keeping the group on the left
    targetScale = 1;
    targetOriginX = screenAnchorX - CENTER_X; // The group will be aligned with the left side
