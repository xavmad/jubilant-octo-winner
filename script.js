...
// Function to reset the camera and allow pan/zoom after exiting group mode
function resetCamera() {
  // Reset camera state after exiting group mode
  cameraLocked = false;
  smoothWheel = 0;
  progress = 0;
  originX = targetOriginX = CAMERA_CENTER_X;
  originY = targetOriginY = CAMERA_CENTER_Y;
  scale = targetScale = 1;

  // Re-enable mouse events for pan and zoom after group mode is exited
