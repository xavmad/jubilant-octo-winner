...
function activateGroup(project) {
  ...
  // Optional: Add motion blur effect
  canvas.style.transition = 'filter 0.5s ease-out';
  canvas.style.filter = 'blur(5px)'; // increase blur during transition
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      ...
      // Restore blur effect after transition
      canvas.style.filter = 'blur(0px)';

    }, 1000); // Adjust this timing to match transition
  }, 520);
}
