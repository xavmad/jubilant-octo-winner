...
if (!IS_MOBILE && Math.abs(smoothWheel) > 0.05) {
  ...
  targetOriginX = lastMouseX - worldX * targetScale;
  targetOriginY = lastMouseY - worldY * targetScale;
}
...
targetScale = newScale;
targetOriginX = midX - worldX * targetScale;
targetOriginY = midY - worldY * targetScale;
