...
// Camera Loop for smooth transitions (Zoom-out and Zoom-in)
...
function activateGroup(project) {
  ...
  // Set the targetOriginX and targetOriginY to focus on the center of the screen
  ...
  // Now, add the image formation delay (400ms) after zoom-out
  setTimeout(() => {
  ...
  }, 800); // Initial delay for zoom-out (800ms)
}
